MACRO map_exit ; 9 bytes
	db \1, \2 ; x,y coords of exit
	db \3 ; destination MAP_* id
	db \4, \5 ; x,y coords to load player in dest map
	db \6 ; direction player faces when loaded in dest map
	dba \7 ; bank, address of function to call on map exit
ENDM
...
MACRO npc ; 6 bytes
	...
	db \2, \3 ; x,y coords
	db \4 ; direction
	dw \5 ; addr of function that decides if NPC should be loaded (this bank)
ENDM

MACRO npc_script_location ; 4 bytes
	db \1 ; OW_* object id
	dba \2 ; bank, address of NPC event script data
ENDM

MACRO ow_script_location ; 9 bytes
	db \1, \2 ; x,y coordinates
	db $00, $00, $00, $00 ; unused?
	dba \3 ; bank, addr of event function
ENDM
...
; map exits
	; x, y, dest MAP id, dest x, dest y, direction, (bank, addr of function)
Data_2da2b:
	db $0F, $06, $0F, $01, $03, $01, $03, $C4, $53 
	db $0F, $07, $0F, $01, $04, $01, $03, $C4, $53
	db $ff

; OW id, x, y, direction, function addr for function that decides if npc is here (in this bank)
Data_2da3e:
	db OW_PAPPY_2, $01, $05, SOUTH, $00, $00
	db OW_SPECS_3, $04, $09, EAST, $00, $00
	db OW_LAD4, $07, $09, WEST, $00, $00
	db OW_GIRL_4, $06, $08, SOUTH, $00, $00
	db OW_CLERK_1, $02, $02, SOUTH, $00, $00
	db OW_CLERK_2, $04, $02, SOUTH, $00, $00
	db OW_MANIA_2, $0B, $06, EAST, $97, $5B
	db $ff

; OW id, bank, address of NPC script
Data_2da69:
	db OW_PAPPY_2, $0B, $AC, $5B 
	db OW_SPECS_3, $0B, $17, $5C 
	db OW_LAD4, $0B, $48, $5C 
	db OW_GIRL_4, $0B, $79, $5C 
	db OW_MANIA_2, $0B, $0E, $5B
	db $ff

; overworld object scripts. used by link clerk desks, computer, bookshelves, etc
; x, y, 00?, 00?, 00?, 00?, bank, addr of event function
Data_2da7e:
	db $08, $02, $00, $00, $00, $00, $03, $11, $54 ; PC
	db $09, $02, $00, $00, $00, $00, $03, $11, $54 ; PC
	db $02, $04, $00, $00, $00, $00, $0F, $B9, $41 ; desk before left clerk
	db $04, $04, $00, $00, $00, $00, $0F, $D9, $42 ; desk before right clerk
	db $0C, $02, $00, $00, $00, $00, $10, $4A, $41 ; bookshelf
	db $0D, $02, $00, $00, $00, $00, $10, $60, $41 ; bookshelf
	db $0E, $02, $00, $00, $00, $00, $10, $76, $41 ; bookshelf
	db $ff
